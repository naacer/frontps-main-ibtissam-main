    ...
    return async (dispatch) =>{
        ...
        try {
            ...
            dispatch({type:DELETE_EVENTS_SUCCESS,payload:eventId});
             ...
             console.log("catch error", error)
            dispatch({type:DELETE_EVENTS_FAILURE,
                payload:error
            });
        }
